...
})({"1bdgd":[function(require,module,exports) {
"use strict";
var HMR_HOST = null;
var HMR_PORT = null;
...
inputData.addEventListener('keypress', (ev)=>{
    const elem = ev.target;
    if (ev.key.toLowerCase() === 'enter' && elem.value) encrypt(elem.value, showEncription);
});
function showEncription(data) {
    const inputShowEnc = document.querySelector('#encription');
    const divToShowData = document.querySelector('#decripted-data');
...
function encrypt(dataToEncrypt, callback) {
    ...
    _crypto.encryptDataWithPublicKey(dataToEncrypt).then((data)=>{
        const dataBase64 = _uint8ToBase64.encode(data);
        dataToSend.encShow = dataBase64;
        fetch('https://criptopruebas.azurewebsites.net/WeatherForecast', {
            method: 'POST',
            headers: {
...
},{"./crypto":"eMn2T","uint8-to-base64":"gcOzN"}],"eMn2T":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
parcelHelpers.export(exports, "encryptDataWithPublicKey", ()=>encryptDataWithPublicKey
);
...
const encryptDataWithPublicKey = async (data)=>{
    ...
    const jsKey = await window.crypto.subtle.importKey("spki", pemArrayBufferKey, {
        name: "RSA-OAEP",
        hash: "SHA-1"
    }, true, [
        'encrypt'
...
},{"@parcel/transformer-js/src/esmodule-helpers.js":"jJAcE"}],"jJAcE":[function(require,module,exports) {
...
},{}],"gcOzN":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
...
},{"@parcel/transformer-js/src/esmodule-helpers.js":"jJAcE"}]},["1bdgd","jeorp"], "jeorp", "parcelRequired4ee")
